...
(function(){
  ...
  const CROSS_Y={AB:[280,500],AC:[400,550],BC:[480,650],ABC:[350,550]};

  // Group by stage + base modality
  const groups={};
  N.forEach(n=>{
    if(n.st===5||n.st===6||n.type==="repr"||n.type==="struct")return;
  ...
  f("st-sa").x=SX[4];f("st-sa").y=380;
  f("st-ffn").x=SX[4]+5;f("st-ffn").y=440;
  f("st-an").x=SX[4.5];f("st-an").y=420;
